    ...
    return (
        <div className='flex overflow-hidden rounded-md border-2 border-gray-500'>
            <button
                ...
                className={clsx(theme === 'system' ? 'bg-red-600 text-white' : '')}>
            ...
            <button
                ...
                className={clsx(theme === 'light' ? 'bg-red-600 text-white' : '')}>
            ...
            <button onClick={() => setTheme('dark')} className={clsx(theme === 'dark' ? 'bg-red-600 text-white' : '')}>
                <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 256 256' className='m-2 h-6 w-6'>
                    <rect x='0' y='0' width='256' height='256' fill='none' stroke='none' />
                    <path
                        fill='currentColor'
